...
export default function EmpleadoForm({
  ...
  const handleSubmit = async (e) => {
    ...
    if (!salario && salario !== 0) { setLocalError('El salario es obligatorio'); return; }
    if (!fechaIngreso) { setLocalError('La fecha de ingreso es obligatoria'); return; }
    if (!personaId) {
    ...
    <form className="empresa-form" onSubmit={handleSubmit}>
      <div className="form-head">
        <div>
          ...
          <h3>{mode === 'edit' ? 'Editar empleado' : 'Crear empleado'}</h3>
        </div>
      ...
      <div className="form-grid">
        ...
        <label>
          ...
          <input
            ...
            required
          />
          {fieldErrors.salario && <p className="error-text">* {fieldErrors.salario}</p>}
        </label>
        <label>
          ...
          <input
            ...
            required
          />
          {fieldErrors.fechaIngreso && <p className="error-text">* {fieldErrors.fechaIngreso}</p>}
        </label>
        <label>
          ...
          />
          {fieldErrors.fechaNacimiento && <p className="error-text">* {fieldErrors.fechaNacimiento}</p>}
        </label>
        <label>
          ...
          />
          {fieldErrors.fechaSalida && <p className="error-text">* {fieldErrors.fechaSalida}</p>}
        </label>
        <label>
          <span>Rol *</span>
          <select
